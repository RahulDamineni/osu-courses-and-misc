...
ray.init(num_cpus=4, include_webui=False, ignore_reinit_error=True,
         redis_max_memory=1000000000, object_store_memory=10000000000)
...
first_batch, second_batch = ray.wait(result_ids, num_returns=3, timeout=None)
initial_results = ray.get(first_batch)
...
remaining_results = ray.get(second_batch)
